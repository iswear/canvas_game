...
// $.ui might exist from components with no dependencies, e.g., $.ui.position
    ...
    $.getScrollbarWidth = function () {
        if (!$.context_temp.scrollbarWidth) {
            ...
            $.context_temp.scrollbarWidth = ele[0].offsetWidth - ele[0].scrollWidth;
            ele.remove();
        }
        return $.context_temp.scrollbarWidth;
    }

    $.svg = function (tagName) {
        return $(document.createElementNS("http://www.w3.org/2000/svg", tagName));
    }
    $.getElementPageOffset = function (element) {
        var left = 0;
        var top = 0;
        var doc = document;
        var body = doc.body;
...
// fraction support test
    ...
    var contextmenu = $.widget("ui.contextmenu", {
        version: "1.11.4",
        defaultElement: "<ul>",
        delay: 300,
        options: {
...
// a full solution for string manipulation and internationalization.
    ...
    var tree = $.widget("ui.tree", {
        ...
        _nodeDragging: false,
        _create: function () {
            this.element.addClass("ui-tree");
            this._createTreeNode(this.element, this.options.root, 0);
        },
        _createTreeNode: function ($element, node) {
            if (node) {
                ...
                if (node.expanded) {
                    $treeNodeControlIcon.removeClass("ui-icon-triangle-1-e")
                        .addClass("ui-icon ui-icon-triangle-1-se");
                } else {
                    $treeNodeControlIcon.removeClass("ui-icon-triangle-1-se")
                ...
                if (!node.leaf && node.children) {
                    ...
                    for (var i = 0, len = children.length; i < len; ++i) {
                        if (!node.expanded) {
                            $treeNodeChildren.css("display", "none");
                        }
                ...
                this._on($treeNodeContent, {
                    ...
                    mouseup: "_nodeContentMouseUp",
                    mousemove: "_nodeContentMouseMove",
                    mouseover: "_nodeContentMouseOver",
                    mouseout: "_nodeContentMouseOut"
                });
                this._on($(document), {
                    mouseup: "_documentMouseUp",
                    mousemove: "_documentMouseMove"
                });
            }
        },
        _controlIconClick: function (event) {
            var $controlIcon = $(event.currentTarget);
            var $treeNode = $controlIcon.parent().parent();
            var $treeNodeControlIcon = $treeNode.children(".ui-tree-content").children(".ui-tree-control-icon");
            var $treeNodeChildren = $treeNode.children(".ui-tree-node-children");
            if ($treeNodeChildren.css("display") == "none") {
                $treeNodeControlIcon.removeClass("ui-icon-triangle-1-e").addClass("ui-icon-triangle-1-se");
                $treeNodeChildren.css("display", "");
            } else {
                $treeNodeControlIcon.removeClass("ui-icon-triangle-1-se").addClass("ui-icon-triangle-1-e");
                $treeNodeChildren.css("display", "none");
            }
        },
        ...
        _nodeContentMouseMove: function (event) {
            if (this._nodeDragging) {
                var treeNodeContent = event.currentTarget;
                if (treeNodeContent != this._selectedElement) {
                    var $treeNodeContent = $(event.currentTarget);
        ...
        _nodeContentMouseUp: function (event) {
            if (this._nodeDragging) {

            } else {
                var target = event.target;
                if ($(target).hasClass("ui-tree-control-icon")) {
                    var $treeNodeControlIcon = $(target);
                    var $treeNodeContent = $(event.currentTarget);
                    var $treeNodeChildren = $treeNodeContent.parent().children(".ui-tree-node-children");
                    if ($treeNodeChildren.css("display") == "none") {
                        $treeNodeControlIcon.removeClass("ui-icon-triangle-1-e").addClass("ui-icon-triangle-1-se");
                        $treeNodeChildren.css("display", "");
                    } else {
        ...
        _nodeContentMouseOver: function (event) {
            this._mouseOverElement = event.currentTarget;
        },
        _nodeContentMouseOut: function (event) {
            if (this._nodeDragging) {
                if (event.currentTarget != this._selectedElement) {
                    var $treeNodeContent = $(event.currentTarget);
                    $treeNodeContent.removeClass("ui-tree-content-insert-before ui-tree-content-insert-at ui-corner-s-all ui-tree-content-insert-after");
                }
            }
        },
        ...
        _documentMouseUp: function (event) {
            if (this._mouseOverElement) {
                $(this._mouseOverElement).removeClass("ui-tree-content-insert-before")
                    .removeClass("ui-tree-content-insert-at")
                    .removeClass("ui-tree-content-insert-after");
            }
    ...
    var timerule = $.widget("ui.timerule", {
        version: "1.11.4",
        options: {
            duration: 10
        },
        _create: function () {
            this.element.addClass("ui-timerule");
            var len = this.options.duration * 10;
            var appendStr = [];
            for (var i = 0, left = 0; i < len; ++i, left += 0.7) {
                if (i % 10 == 0) {
                    appendStr.push('<span class="ui-timerule-cell ui-timerule-cell-l" style="left: '
                        + left + 'em;">' + (i / 10) + '</span>');
                } else if (i % 5 == 0) {
                    appendStr.push('<span class="ui-timerule-cell ui-timerule-cell-m" style="left: '
                        + left + 'em;"></span>');
                } else {
                    appendStr.push('<span class="ui-timerule-cell ui-timerule-cell-s" style="left: '
                        + left + 'em;"></span>');
                }
            }
            this.element.html(appendStr.join(""));
        }
    });

    var timeline = $.widget("ui.timeline", {
        version: "1.11.4",
        options: {
            duration: 10,
        },
        _$keyframe: null,
        _create: function () {
            this.element.addClass("ui-timeline");
            var len = this.options.duration * 10;
            var appendStr = [];
            for (var i = 0, left = 0; i < len; ++i, left += 0.7) {
                appendStr.push('<span class="ui-timeline-cell" style="left: '
                    + left + 'em;"></span>');
            }
            this.element.html(appendStr.join(""));
            this._on(this.element, {
                mousedown: "_mousedownTimeline"
            })
        },
        _mousedownTimeline: function (event) {
            var currentTarget = event.currentTarget;
            var offsetX = event.pageX - $.getElementPageOffset(currentTarget).left;
        }
    });

    var beziereditor = $.widget("ui.beziereditor", {
        version: '1.11.4',
        options: {
            padding: 0.2
        },
        _$svg: null,
        _$svgPath: null,
        _$controlSource: null,
        _$controlTarget: null,
        _create: function () {
            var posStyle = this.element.css("position");
            this.element.addClass("ui-beziereditor");
            if (!(posStyle == "relative" || posStyle == "absolute" || posStyle == "fixed")) {
                this.element.css("position", "relative");
            }
            this.element.addClass("ui-beziereditor").css({
                width: this.options.width + "px",
                height: this.options.height + "px"
            });
            this._$svg = $.svg("svg").css({
                'width': '100%',
                'height': '100%'
            });
            this._$svgPath = $.svg("path").css({
                'stroke': 'black',
                'stroke-width': '1',
                'fill': 'none'
            });
            this._$controlSource = $("<span>").addClass("ui-beziereditor-ctrl-point").css({
                right: "0px",
                bottom: "0px",
                background: "blue"
            }).css("position", "absolute").draggable({
                drag: this._paintBezierCurve.bind(this),
                stop: this._paintBezierCurve.bind(this)
            });
            this._$controlTarget = $("<span>").addClass("ui-beziereditor-ctrl-point").css({
                left: "50%",
                top: "50%",
                background: "green"
            }).css("position", "absolute").draggable({
            ...
            this._$svg.append(this._$svgPath);
            this.element.append(this._$svg);
            this.element.append(this._$controlSource);
            this.element.append(this._$controlTarget);
            this._paintBezierCurve();
        },
        _paintBezierCurve: function () {
            if (this.options.padding >= 0 && this.options.padding < 0.5) {
                var padding = this.options.padding;
                var width = this._$svg.innerWidth();
                var height = this._$svg.innerHeight();
                var paddingX = width * padding;
                var paddingY = height * padding;

                var point1X = paddingX;
                var point1Y = this._$svg.innerHeight() - paddingY;
                var point2X = this._$controlSource.position().left + 4;
                var point2Y = this._$controlSource.position().top + 4;
                var point3X = this._$controlTarget.position().left + 4;
                var point3Y = this._$controlTarget.position().top + 4;
                var point4X = this._$svg.innerWidth() - paddingX;
                var point4Y = paddingY;

                var cmd = "M " + point1X + " " + point1Y
                    + " Q " + point2X + " " + point2Y
                    + " " + point3X + " " + point3Y
                    + " T " + point4X + " " + point4Y;
    ...
    var layout = $.widget("ui.layout", {
        ...
        _create: function () {
            ...
            if (this._$splitZone.length == 0) {
                this._$splitZone = $("<div>").addClass("ui-layout-split ui-state-active");
                this.element.append(this._$splitZone);
            } else {
                this._$splitZone.addClass("ui-state-active");
            }
            this._$splitZone.css({
                "display": "none"
            });
            this._on(this.element, {
            ...
            this._layoutElements(0);
        },
        _layoutElements: function (layoutSrcType) {
            var centerLeft = 0;
            var centerTop = 0;
            var centerRight = 0;
            var centerBottom = 0;
            if (this._$northZone == null) {
                ...
                centerTop = this._layoutParam.northHeight + 1;
            }
            ...
            if (this._$northZone != null) {
                this._$northZone.css({
                    "height": this._layoutParam.northHeight + "px"
                });
            }
            if (this._$southZone != null) {
                this._$southZone.css({
                    "height": this._layoutParam.southHeight + "px"
                })
            }
            if (this._$eastZone != null) {
                this._$eastZone.css({
                    "width": this._layoutParam.eastWidth + "px",
                    "top": centerTop + "px",
            ...
            if (this._$westZone != null) {
                this._$westZone.css({
                    "width": this._layoutParam.westWidth + "px",
                    "top": centerTop + "px",
                    "bottom": centerBottom + "px"
                });
            }
            this._$centerZone.css({
                "left": centerLeft + "px",
                "top": centerTop + "px",
                "right": centerRight + "px",
                "bottom": centerBottom + "px"
            })
            this.element.trigger("relayout", this, layoutSrcType);
        },
        _mousedownElement: function (event) {
            var pageOffset = $.getElementPageOffset(this.element.get(0));
            var localX = event.pageX - pageOffset.left;
            var localY = event.pageY - pageOffset.top;
            this._splitStatus.eventStartLeft = event.pageX;
            this._splitStatus.eventStartTop = event.pageY;
            ...
            if (this._$northZone != null &&
                ...
                this._splitStatus.splitStartVer = this._layoutParam.northHeight;
                this._$splitZone.css({
                    "left": 0,
                    "top": this._splitStatus.splitStartVer + "px",
                    "right": 0,
                    "bottom": "",
                    "width": "",
                    "height": "1px",
            ...
            if (this._$southZone != null &&
                ...
                this._splitStatus.splitStartHor = 0;
                this._splitStatus.splitStartVer = this._layoutParam.southHeight;
                this._$splitZone.css({
                    "left": 0,
                    "top": "",
                    "right": 0,
                    "bottom": this._splitStatus.splitStartVer + "px",
                    "width": "",
                    "height": "1px",
                    "display": "block"
                });
            ...
            if (this._$westZone != null &&
                ...
                this._splitStatus.splitStartVer = (this._layoutParam.northHeight + 1);
                this._$splitZone.css({
                    "left": this._splitStatus.splitStartHor + "px",
                    "top": this._splitStatus.splitStartVer + "px",
                    "right": '',
                    "bottom": (this._layoutParam.southHeight + 1) + "px",
                    "width": "1px",
                    "height": "",
                    "display": "block"
                });
            ...
            if (this._$eastZone != null &&
                ...
                this._$splitZone.css({
                    "left": "",
                    "top": this._splitStatus.splitStartVer + "px",
                    "right": this._splitStatus.splitStartHor + "px",
                    "bottom": (this._layoutParam.southHeight + 1) + "px",
                    "width": "1px",
                    "height": "",
                    "display": "block"
        ...
        _mousemoveElement: function (event) {
            switch (this._splitStatus.type) {
                case 1:
                {
                    var offsetY = event.pageY - this._splitStatus.eventStartTop;
                    var newTop = this._splitStatus.splitStartVer + offsetY;
                    this._$splitZone.css({
                        "top": newTop + "px"
                    });
                    event.preventDefault();
                ...
                {
                    var offsetY = event.pageY - this._splitStatus.eventStartTop;
                    var newBottom = this._splitStatus.splitStartVer - offsetY;
                    this._$splitZone.css({
                        "bottom": newBottom + "px"
                    });
                    event.preventDefault();
                ...
                case 3:
                {
                    var offsetX = event.pageX - this._splitStatus.eventStartLeft;
                    var newLeft = this._splitStatus.splitStartHor + offsetX;
                    this._$splitZone.css({
                        "left": newLeft + "px"
                    });
                    event.preventDefault();
                ...
                {
                    var offsetX = event.pageX - this._splitStatus.eventStartLeft;
                    var newRight = this._splitStatus.splitStartHor - offsetX;
                    this._$splitZone.css({
                        "right": newRight + "px"
                    });
                    event.preventDefault();
        ...
        _mouseupDocument: function (event) {
            switch (this._splitStatus.type) {
                case 1:
                {
                    this._splitStatus.type = 0;
                    var offsetY = event.pageY - this._splitStatus.eventStartTop;
                    this._layoutParam.northHeight += offsetY;
                    this._layoutElements(1);
                    this._$splitZone.css({
                        "top": "",
                        "display": "none"
                    });
        ...
        _create: function () {
            ...
            for (var i = 0, len = $items.length; i < len; ++i) {
                ...
                $item.children("ul")
                    .contextmenu()
                    .hide()
                    .on("contextmenuselect", function (event, ui) {
